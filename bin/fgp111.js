...
Proyectos:
  ...
  fgp create express-auth [nombre]
...
} else if (args[0] === "create" && args[1] === "express-auth") {
  const projectName = args[2] || "fgp-express-auth-app";
  require("../commands/create-express-auth")(projectName);
